...
public class ExpensiveActivity extends AppCompatActivity {
    ...
    private void loadMainData() {
        ...
        myExpensiveList.add(mExpensiveData);
        mExpensiveData = new ExpensiveData("Rolls Royce Submariner-Steve McQueen’s 1967", "You could argue that Steve McQueen’s 1967 Rolls Royce Submariner started the modern craving for expensive Rolls Royce Motor Cars. The watch is the first in our list to be sold for a high price at an auction in 2009. Organized by Antiquorum, the auction closed at $234,000, which was the highest price ever paid for a expensive Rolls Royce at the time."
