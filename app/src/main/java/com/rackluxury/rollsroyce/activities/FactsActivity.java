...
public class FactsActivity extends AppCompatActivity {
    ...
    private void factsMain() {
        ...
        models.add(new Model(R.drawable.fifth_facts, "", "A premium car calls for a premium driving experience. The folks at Rolls Royce empathize with this fact and they’ve come up with apt training to hone the skills of the chauffeurs for the premium cars – The Rolls Royce White Glove experience. Some of the etiquettes taught in the program include never greeting a guest with sunglasses on and never propping up the sunglasses on the head or the back of the neck when the guest is around. This and many more such etiquettes that chauffeurs tend to neglect. Keep the manners intact and be worthy of a handsome tip!"));
